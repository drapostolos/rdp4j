...
public interface FileElement {
     ...
     * <p>
     * Returning a {@code 0L} value will be treated the same as if an {@link IOException} was
     * thrown.
     * 
     * @return A long value representing the time this {@link FileElement} was last modified.
     ...
     *         implementation).
     * @throws RuntimeException if any unexpected crashes occurs. This will cause
